...
#+BEGIN_SRC emacs-lisp
  (defvar *bib-dir* "/home/max/windows_d/prom/research/bib"
    "Directory to a *.bib-file for usage with org-ref.")

  (if (file-directory-p *bib-dir*)
      (progn
        (setq bibtex-completion-bibliography (list (expand-file-name (concat *bib-dir* "/Promotion.bib"))))
